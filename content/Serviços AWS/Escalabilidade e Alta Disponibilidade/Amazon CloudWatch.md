...
* conexões de banco;
* uso de disco;
* duração de função [[AWS Lambda|Lambda]].
...
* monitorar CPU de [[Amazon EC2|EC2]];
* acompanhar latência de ALB;
* registrar logs de [[AWS Lambda|Lambda]];
...
* CPU alta em [[Amazon EC2|EC2]];
* erro em [[AWS Lambda|Lambda]];
* fila [[Amazon SQS|SQS]] crescendo demais;
...
CloudTrail mostra ações de [[APIs|API]] e auditoria.
