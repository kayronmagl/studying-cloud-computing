...
Alta Disponibilidade pertence ao desenho de disponibilidade, crescimento e recuperação. O objetivo é manter a aplicação funcionando quando há aumento de demanda, falha parcial ou necessidade de trocar tráfego para outro recurso.

---

## Por que existe

Alta Disponibilidade existe para manter aplicações disponíveis, responsivas e recuperáveis quando há aumento de demanda, falhas ou variações no ambiente. Sem esse tipo de desenho, crescimento e falha viram eventos manuais e arriscados.
...
Uma aplicação com uma única instância [[Amazon EC2|EC2]] tem baixa disponibilidade porque essa instância é um ponto único de falha. Se ela parar, a aplicação para junto.
