AWS Marketplace é um catálogo digital onde você encontra softwares de fornecedores independentes para usar com a AWS.
...
O AWS Marketplace ajuda a encontrar e adquirir essas soluções.
...
Ela pode procurar essa ferramenta no AWS Marketplace, ver o modelo de cobrança e implantar conforme o produto permite.
...
Ela procura no Marketplace um produto de um fornecedor especializado, como uma ferramenta de firewall, proteção, monitoramento ou backup.

Esse produto não vira automaticamente “serviço nativo da AWS”. Ele continua sendo software de terceiro, mas pode ser comprado e usado dentro do ecossistema AWS.

Quando aparecer a ideia de software de fornecedor independente, pense em Marketplace.
