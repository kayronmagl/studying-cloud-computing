Redes de Computadores conectam sistemas para troca de dados. Incluem endereçamento, roteamento, protocolos, portas, segurança e transmissão. Na AWS, aparecem em [[Amazon VPC]], [[Subnets]], [[Route Tables]] e [[Security Groups]].
