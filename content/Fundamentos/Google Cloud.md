...
Google Cloud deve ser entendido como base para interpretar a nuvem. Fundamentos explicam o que já existia antes dos provedores e continua aparecendo em serviços modernos.

---

## Por que existe

Google Cloud existe porque nuvem não substitui os fundamentos de computação. Ela reorganiza infraestrutura, rede, dados, segurança e operação em serviços consumíveis.

---

## Como funciona

Google Cloud funciona conectando teoria e prática: recurso físico, abstração lógica, software, comunicação, permissão, observação e custo. Essa ligação impede estudar serviços como nomes soltos.
...
Compare Google Cloud com serviços específicos da AWS. Fundamento explica a ideia geral; serviço é uma implementação concreta dessa ideia dentro de um provedor.
