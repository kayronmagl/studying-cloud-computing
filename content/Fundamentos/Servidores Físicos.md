Servidores Físicos são máquinas corporativas reais com CPU, memória, discos, rede e energia. Na nuvem, o usuário consome abstrações como [[Amazon EC2]] sem gerenciar diretamente o hardware.
