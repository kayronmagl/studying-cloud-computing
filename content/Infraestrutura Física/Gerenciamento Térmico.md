Gerenciamento Térmico controla calor em data centers. Usa [[HVAC (Heating, Ventilation, and Air Conditioning)]], fluxo de ar e técnicas de resfriamento para proteger hardware.

---

## O que é

Gerenciamento Térmico deve ser entendido como parte da base material que sustenta a nuvem. Mesmo quando o usuário acessa serviços pela internet, existem instalações, energia, refrigeração, servidores, redes e controles físicos operando continuamente.
...
Gerenciamento Térmico funciona dentro de uma cadeia física: equipamentos são instalados, alimentados, refrigerados, conectados, monitorados e protegidos. Falhas nessa base explicam por que existem redundância, zonas, regiões e planos de recuperação.
...
Compare Gerenciamento Térmico com recursos lógicos como instâncias, buckets e bancos gerenciados. O recurso lógico é o que o cliente configura; a infraestrutura física é o que torna esse recurso possível.
...
Pense em Gerenciamento Térmico como a parte que normalmente fica invisível para quem usa nuvem. Você não administra isso diretamente, mas esse conceito explica por que existem regiões, zonas, redundância e preocupação com disponibilidade.
