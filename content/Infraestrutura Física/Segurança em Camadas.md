Segurança em Camadas combina controles físicos, lógicos e operacionais. Na AWS, envolve data centers, [[AWS Identity and Access Management (IAM)|IAM]], rede, criptografia e monitoramento.

---

## O que é

Segurança em Camadas deve ser entendido como parte da base material que sustenta a nuvem. Mesmo quando o usuário acessa serviços pela internet, existem instalações, energia, refrigeração, servidores, redes e controles físicos operando continuamente.
...
Segurança em Camadas funciona dentro de uma cadeia física: equipamentos são instalados, alimentados, refrigerados, conectados, monitorados e protegidos. Falhas nessa base explicam por que existem redundância, zonas, regiões e planos de recuperação.
...
Compare Segurança em Camadas com recursos lógicos como instâncias, buckets e bancos gerenciados. O recurso lógico é o que o cliente configura; a infraestrutura física é o que torna esse recurso possível.
