...
Uma empresa precisa mudar a forma como compra tecnologia, treina pessoas, controla custos, protege dados, opera sistemas e mede valor. O AWS CAF ajuda a organizar essas mudanças em capacidades e perspectivas.

As seis perspectivas do CAF são Business, People, Governance, Platform, Security e Operations.
...
A parte técnica pergunta quais serviços serão usados. O CAF amplia a conversa: a liderança entende o valor da nuvem? As equipes estão preparadas? Há governança de contas, custos e riscos? A plataforma base está pronta? A segurança foi planejada? A operação consegue manter e recuperar os serviços?

Essas perguntas mostram que CAF olha a organização, não apenas a arquitetura de uma aplicação.
