Perspectivas do AWS CAF são as seis áreas usadas pelo AWS Cloud Adoption Framework para organizar a transformação em nuvem.
...
As perspectivas existem para lembrar que nuvem envolve toda a organização.
...
* controle, risco, prioridade, políticas: Governança.
* arquitetura, landing zone, infraestrutura: Plataforma.
...
Governança pergunta: estamos controlando e direcionando a transformação corretamente?

Segurança pergunta: estamos protegendo dados, sistemas, identidades e workloads?

As duas se conectam, mas têm foco diferente.
